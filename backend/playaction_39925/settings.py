"""
Django settings for playaction_39925 project.
...
ROOT_URLCONF = 'playaction_39925.urls'
...
WSGI_APPLICATION = 'playaction_39925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "playaction_39925 API",
    "DESCRIPTION": "API documentation for playaction_39925 App",
    "VERSION": "v1",
}
